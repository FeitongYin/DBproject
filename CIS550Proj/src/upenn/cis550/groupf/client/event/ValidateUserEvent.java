...
public class ValidateUserEvent extends GwtEvent<ValidateUserEvent.Handler> {
	private String username;
	private String password;
	private String email;
	private AsyncCallback<Boolean> callback;
	
	public ValidateUserEvent(String username, String password, String email, AsyncCallback<Boolean> asyncCallback) {
	...
	public static Type<ValidateUserEvent.Handler> TYPE = 
			new Type<ValidateUserEvent.Handler>();
